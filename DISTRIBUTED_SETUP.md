...
cargo run -- \
  ...
  --peers "2=10.40.41.162:7002,3=10.40.46.168:7003" \
  --http-peers "2=10.40.41.162:8002,3=10.40.46.168:8003"
```
...
cargo run -- \
  ...
  --peers "1=10.40.49.211:7001,3=10.40.46.168:7003" \
  --http-peers "1=10.40.49.211:8001,3=10.40.46.168:8003"
```
...
cargo run -- \
  --id 3 \
  --http-addr 10.40.46.168:8003 \
  --rpc-addr 10.40.46.168:7003 \
...
curl http://10.40.46.168:8003/metrics
```
